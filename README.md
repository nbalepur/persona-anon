...
3. Fill in the API keys in `.env` depending on which functionality of the respository you want to use:
```bash
...
### Augmentating your Preference Data
...
| **Argument**            | **Sample Value**                | **Description**                                                      |
|--------------------------|--------------------------|----------------------------------------------------------------------|
| `dataset_name`           | `"nbalepur/persona-inference"`                    | Original Hugginface dataset path name.                                               |
...
| `new_dataset_name`       | `"nbalepur/persona-inference-augmented"`                    | New name for the Huggingface dataset after augmentation.                         |
